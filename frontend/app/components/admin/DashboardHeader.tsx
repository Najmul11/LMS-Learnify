...
const DashboardHeader = () => {
  ...
  return (
    <div className="w-full flex items-center justify-end p-6 fixed top-5 right-0 z-[100000]">
      <ThemeSwitcher />
      ...
      {open && (
        <div
          ref={notificationRef}
          className="w-[350px] h-[50vh] dark:bg-[#111C43] bg-white shadow-xl absolute top-16 z-[100000000] rounded"
        >
          <h5 className="text-center text-[20px] font-Poppins dark:text-white p-3">
            Notifications
          </h5>
          <div className="dark:bg-[#2d3a4ea1] bg-[#00000013] font-Poppins border-b dark:border-b-[#ffffff47] border-b-[#0000000f]">
            ...
            <p className="p-2 dark:text-white text-[14px]">5 days ago</p>
          </div>
          <div className="dark:bg-[#2d3a4ea1] bg-[#00000013] font-Poppins border-b dark:border-b-[#ffffff47] border-b-[#0000000f]">
            <div className="w-full flex items-center justify-between p-2">
              <p className="text-black dark:text-white">
