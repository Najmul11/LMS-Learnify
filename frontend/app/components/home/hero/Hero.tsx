...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col gap-6 items-center justify-center min-h-[65vh] 800px:min-h-[87vh]">
      ...
      <p className="800px:block hidden font-poppins 800px:text-[22px] 800px:leading-[32px] text-[16px] leading-[23px] font-normal text-[#003A55]  dark:text-[#A3b3BC]">
        Empower your programming journey with Learnify <br /> dedicated
        community and comprehensive resources.
      </p>
      <p className="text-center 800px:hidden font-poppins 800px:text-[22px] 800px:leading-[32px] text-[16px] leading-[25px] font-normal text-[#003A55] ">
        Empower your programming journey with <br className="800px:hidden" />{" "}
        Learnify dedicated community and <br className="800px:hidden" />
